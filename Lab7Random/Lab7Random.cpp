...
// Lab7Random.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CLab7RandomApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CLab7RandomApp

CLab7RandomApp::CLab7RandomApp()
{
...
// Единственный объект CLab7RandomApp

CLab7RandomApp theApp;


// Инициализация CLab7RandomApp

BOOL CLab7RandomApp::InitInstance()
{
